...
X = np.array(model_data[['stand_age_interval_min','tmp_ratio', 'precip_ratio',
        'co2_ratio']])
...
num_iterations = 5000  # Choose an appropriate number of iterations for your problem
...
save_name = "gp_720ip_5000iter_4_vars"
