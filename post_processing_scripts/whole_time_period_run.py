...
ensemble_dir = '/group/moniergrp/TEM_Large_Ensemble/run_support_files/whole_time/'
# ensemble_model = 'CanESM5xx1'
output_dir_path = '/group/moniergrp/TEM_Large_Ensemble/output_files/CanESM5_whole_time/' 
